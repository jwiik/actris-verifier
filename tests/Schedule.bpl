  ...
  modifies C, R, M, St;
{
  ...
  assert {:msg "  16.15: Channel invariant might not hold on action entry"} (R[Top#c] + C[Top#c]) == (R[Top#a] + R[Top#b]);
  assert {:msg "  17.15: Channel invariant might not hold on action entry"} ((R[Top#c] + C[Top#c]) >= 1) ==> (C[Top#a] == 0);
  assert {:msg "  18.15: Channel invariant might not hold on action entry"} ((R[Top#c] + C[Top#c]) >= 2) ==> (C[Top#b] == 0);
  assert {:msg "  19.15: Channel invariant might not hold on action entry"} (R[Top#a] == 0) && (R[Top#b] == 0) ==> (St[Top#fm] == FairMerge#s1);
  assert {:msg "  20.15: Channel invariant might not hold on action entry"} (R[Top#a] == 1) && (R[Top#b] == 0) ==> (St[Top#fm] == FairMerge#s2);
  assert {:msg "  21.15: Channel invariant might not hold on action entry"} (R[Top#a] == 1) && (R[Top#b] == 1) ==> (St[Top#fm] == FairMerge#s1);
  assert {:msg "  23.15: Channel invariant might not hold on action entry"} ((R[Top#c] + C[Top#c]) >= 1) ==> (M[Top#c][0] == M[Top#a][0]);
  assert {:msg "  24.15: Channel invariant might not hold on action entry"} ((R[Top#c] + C[Top#c]) >= 2) ==> (M[Top#c][1] == M[Top#b][0]);
}
  ...
  modifies C, R, M, St;
{
  ...
  assert {:msg "  16.15: Sub-actor action at 2.3 might not preserve the channel invariant"} (R[Top#c] + C[Top#c]) == (R[Top#a] + R[Top#b]);
  assert {:msg "  17.15: Sub-actor action at 2.3 might not preserve the channel invariant"} ((R[Top#c] + C[Top#c]) >= 1) ==> (C[Top#a] == 0);
  assert {:msg "  18.15: Sub-actor action at 2.3 might not preserve the channel invariant"} ((R[Top#c] + C[Top#c]) >= 2) ==> (C[Top#b] == 0);
  assert {:msg "  19.15: Sub-actor action at 2.3 might not preserve the channel invariant"} (R[Top#a] == 0) && (R[Top#b] == 0) ==> (St[Top#fm] == FairMerge#s1);
  assert {:msg "  20.15: Sub-actor action at 2.3 might not preserve the channel invariant"} (R[Top#a] == 1) && (R[Top#b] == 0) ==> (St[Top#fm] == FairMerge#s2);
  assert {:msg "  21.15: Sub-actor action at 2.3 might not preserve the channel invariant"} (R[Top#a] == 1) && (R[Top#b] == 1) ==> (St[Top#fm] == FairMerge#s1);
  assert {:msg "  23.15: Sub-actor action at 2.3 might not preserve the channel invariant"} ((R[Top#c] + C[Top#c]) >= 1) ==> (M[Top#c][0] == M[Top#a][0]);
  assert {:msg "  24.15: Sub-actor action at 2.3 might not preserve the channel invariant"} ((R[Top#c] + C[Top#c]) >= 2) ==> (M[Top#c][1] == M[Top#b][0]);
}
  ...
  modifies C, R, M, St;
{
  ...
  assert {:msg "  16.15: Sub-actor action at 3.3 might not preserve the channel invariant"} (R[Top#c] + C[Top#c]) == (R[Top#a] + R[Top#b]);
  assert {:msg "  17.15: Sub-actor action at 3.3 might not preserve the channel invariant"} ((R[Top#c] + C[Top#c]) >= 1) ==> (C[Top#a] == 0);
  assert {:msg "  18.15: Sub-actor action at 3.3 might not preserve the channel invariant"} ((R[Top#c] + C[Top#c]) >= 2) ==> (C[Top#b] == 0);
  assert {:msg "  19.15: Sub-actor action at 3.3 might not preserve the channel invariant"} (R[Top#a] == 0) && (R[Top#b] == 0) ==> (St[Top#fm] == FairMerge#s1);
  assert {:msg "  20.15: Sub-actor action at 3.3 might not preserve the channel invariant"} (R[Top#a] == 1) && (R[Top#b] == 0) ==> (St[Top#fm] == FairMerge#s2);
  assert {:msg "  21.15: Sub-actor action at 3.3 might not preserve the channel invariant"} (R[Top#a] == 1) && (R[Top#b] == 1) ==> (St[Top#fm] == FairMerge#s1);
  assert {:msg "  23.15: Sub-actor action at 3.3 might not preserve the channel invariant"} ((R[Top#c] + C[Top#c]) >= 1) ==> (M[Top#c][0] == M[Top#a][0]);
  assert {:msg "  24.15: Sub-actor action at 3.3 might not preserve the channel invariant"} ((R[Top#c] + C[Top#c]) >= 2) ==> (M[Top#c][1] == M[Top#b][0]);
}
