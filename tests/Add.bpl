  ...
  modifies C, R, M, St;
{
  ...
  assert {:msg "  12.3: Channel invariant might not hold on action entry"} R[Net#a] == (R[Net#c] + C[Net#c]);
  assert {:msg "  13.3: Channel invariant might not hold on action entry"} R[Net#b] == (R[Net#c] + C[Net#c]);
}
  ...
  modifies C, R, M, St;
{
  ...
  C[Net#c] := C[Net#c] + 1;
  assert {:msg "  Sub-actor action at 3.3 might not preserve the channel invariant (generated #9)"} 0 <= R[Net#a];
  assert {:msg "  Sub-actor action at 3.3 might not preserve the channel invariant (generated #10)"} 0 <= C[Net#a];
  assert {:msg "  Sub-actor action at 3.3 might not preserve the channel invariant (generated #11)"} (R[Net#a] + C[Net#a]) == C#init[Net#a];
  assert {:msg "  Sub-actor action at 3.3 might not preserve the channel invariant (generated #12)"} 0 <= R[Net#b];
  assert {:msg "  Sub-actor action at 3.3 might not preserve the channel invariant (generated #13)"} 0 <= C[Net#b];
  assert {:msg "  Sub-actor action at 3.3 might not preserve the channel invariant (generated #14)"} (R[Net#b] + C[Net#b]) == C#init[Net#b];
  assert {:msg "  Sub-actor action at 3.3 might not preserve the channel invariant (generated #15)"} 0 <= R[Net#c];
  assert {:msg "  Sub-actor action at 3.3 might not preserve the channel invariant (generated #16)"} 0 <= C[Net#c];
  assert {:msg "  Sub-actor action at 3.3 might not preserve the channel invariant (generated #17)"} R[Net#c] == 0;
  assert {:msg "  12.3: Sub-actor action at 3.3 might not preserve the channel invariant"} R[Net#a] == (R[Net#c] + C[Net#c]);
  assert {:msg "  13.3: Sub-actor action at 3.3 might not preserve the channel invariant"} R[Net#b] == (R[Net#c] + C[Net#c]);
}
