  ...
  modifies C#, R#, M#, I#, H#, I#sub;
{
  ...
  assume (Mode#[this#] == Skip) ==> ((C#[AC_PRED_DIR] - I#[AC_PRED_DIR]) <= 1) && ((C#[QFS_AC] - I#[QFS_AC]) == 0);
  assume (Mode#[this#] == Main) ==> ((C#[AC_PRED_DIR] - I#[AC_PRED_DIR]) <= 1) && ((C#[QFS_AC] - I#[QFS_AC]) <= 63);
  assert {:msg "The actions 'done' and 'read_only' of actor 'Algo_IS_simple' might not have mutually exclusive guards (#84)"} !(true && true && (count == 64bv8) && ((St# == read) || (St# == write)) && true && (!(true && (count == 64bv8) && ((St# == read) || (St# == write)))) && (1 <= (C#[QFS_AC] - R#[QFS_AC])) && AT#BvSlt8(count, 64bv8) && (St# == read));
  assert {:msg "The actions 'done' and 'skip' of actor 'Algo_IS_simple' might not have mutually exclusive guards (#85)"} !(true && true && (count == 64bv8) && ((St# == read) || (St# == write)) && true && (1 <= (C#[AC_PRED_DIR] - R#[AC_PRED_DIR])) && AT#BvSlt3(M#[AC_PRED_DIR][R#[AC_PRED_DIR]], 0bv3) && (St# == rest));
  ...
  assert {:msg "The actions 'done' and 'start' of actor 'Algo_IS_simple' might not have mutually exclusive guards (#87)"} !(true && true && (count == 64bv8) && ((St# == read) || (St# == write)) && true && (!((1 <= (C#[AC_PRED_DIR] - R#[AC_PRED_DIR])) && AT#BvSlt3(M#[AC_PRED_DIR][R#[AC_PRED_DIR]], 0bv3) && (St# == rest))) && (1 <= (C#[AC_PRED_DIR] - R#[AC_PRED_DIR])) && AT#BvSge3(M#[AC_PRED_DIR][R#[AC_PRED_DIR]], 0bv3) && (St# == rest));
  assert {:msg "The actions 'read_only' and 'skip' of actor 'Algo_IS_simple' might not have mutually exclusive guards (#88)"} !(true && (!(true && (count == 64bv8) && ((St# == read) || (St# == write)))) && (1 <= (C#[QFS_AC] - R#[QFS_AC])) && AT#BvSlt8(count, 64bv8) && (St# == read) && true && (1 <= (C#[AC_PRED_DIR] - R#[AC_PRED_DIR])) && AT#BvSlt3(M#[AC_PRED_DIR][R#[AC_PRED_DIR]], 0bv3) && (St# == rest));
  assert {:msg "The actions 'read_only' and 'write_only' of actor 'Algo_IS_simple' might not have mutually exclusive guards (#89)"} !(true && (!(true && (count == 64bv8) && ((St# == read) || (St# == write)))) && (1 <= (C#[QFS_AC] - R#[QFS_AC])) && AT#BvSlt8(count, 64bv8) && (St# == read) && true && (!(true && (count == 64bv8) && ((St# == read) || (St# == write)))) && true && AT#BvSlt8(count, 64bv8) && (St# == write));
  assert {:msg "The actions 'read_only' and 'start' of actor 'Algo_IS_simple' might not have mutually exclusive guards (#90)"} !(true && (!(true && (count == 64bv8) && ((St# == read) || (St# == write)))) && (1 <= (C#[QFS_AC] - R#[QFS_AC])) && AT#BvSlt8(count, 64bv8) && (St# == read) && true && (!((1 <= (C#[AC_PRED_DIR] - R#[AC_PRED_DIR])) && AT#BvSlt3(M#[AC_PRED_DIR][R#[AC_PRED_DIR]], 0bv3) && (St# == rest))) && (1 <= (C#[AC_PRED_DIR] - R#[AC_PRED_DIR])) && AT#BvSge3(M#[AC_PRED_DIR][R#[AC_PRED_DIR]], 0bv3) && (St# == rest));
  assert {:msg "The actions 'skip' and 'write_only' of actor 'Algo_IS_simple' might not have mutually exclusive guards (#91)"} !(true && (1 <= (C#[AC_PRED_DIR] - R#[AC_PRED_DIR])) && AT#BvSlt3(M#[AC_PRED_DIR][R#[AC_PRED_DIR]], 0bv3) && (St# == rest) && true && (!(true && (count == 64bv8) && ((St# == read) || (St# == write)))) && true && AT#BvSlt8(count, 64bv8) && (St# == write));
  assert {:msg "The actions 'skip' and 'start' of actor 'Algo_IS_simple' might not have mutually exclusive guards (#92)"} !(true && (1 <= (C#[AC_PRED_DIR] - R#[AC_PRED_DIR])) && AT#BvSlt3(M#[AC_PRED_DIR][R#[AC_PRED_DIR]], 0bv3) && (St# == rest) && true && (!((1 <= (C#[AC_PRED_DIR] - R#[AC_PRED_DIR])) && AT#BvSlt3(M#[AC_PRED_DIR][R#[AC_PRED_DIR]], 0bv3) && (St# == rest))) && (1 <= (C#[AC_PRED_DIR] - R#[AC_PRED_DIR])) && AT#BvSge3(M#[AC_PRED_DIR][R#[AC_PRED_DIR]], 0bv3) && (St# == rest));
  assert {:msg "The actions 'write_only' and 'start' of actor 'Algo_IS_simple' might not have mutually exclusive guards (#93)"} !(true && (!(true && (count == 64bv8) && ((St# == read) || (St# == write)))) && true && AT#BvSlt8(count, 64bv8) && (St# == write) && true && (!((1 <= (C#[AC_PRED_DIR] - R#[AC_PRED_DIR])) && AT#BvSlt3(M#[AC_PRED_DIR][R#[AC_PRED_DIR]], 0bv3) && (St# == rest))) && (1 <= (C#[AC_PRED_DIR] - R#[AC_PRED_DIR])) && AT#BvSge3(M#[AC_PRED_DIR][R#[AC_PRED_DIR]], 0bv3) && (St# == rest));
}
